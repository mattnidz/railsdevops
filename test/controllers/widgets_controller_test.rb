...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { result: @widget.result, search: @widget.search } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { result: @widget.result, search: @widget.search } }
